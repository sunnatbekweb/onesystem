...
export default function LinksSection() {
  const data = [
    {
      icon: <InstagramIcon />,
      texts: "Instagram sahifamizga obuna bo'ling",
      secondIcon: <ChevronIcon />,
      link: "https://github.com/VueMid/Roar",
    },
    {
      icon: <TelegramIcon />,
      texts: "Telegram sahifamizga obuna bo'ling",
      secondIcon: <ChevronIcon />,
      ...
      <section className="links bg-[#2F2F34] pt-[104px] pb-[41px] xl:pt-[84px] xl:pb-[137px]">
        <div className="container links__container w-full px-[16px] flex flex-col justify-center items-start md:px-[36px] lg:px-[48px]">
          ...
          <div className="links__bottom-box w-full flex flex-col justify-start items-start">
            {data.map((item, index) => (
              <div
                className="links__bottom-mini-boxes w-full flex flex-row justify-start items-center gap-4 border-b-2 border-[#444448] py-[24px] text-white duration-100 active:text-[#CF734A] md:gap-7"
                key={index}
              >
                <a
