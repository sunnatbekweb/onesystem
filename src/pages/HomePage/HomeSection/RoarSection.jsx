...
import roar from '../../../assets/icons/roar.svg';
...
export default function RoarSection() {
    ...
    return (
        <div>
            <section className="roar relative bg-[#CF734A] pt-[20px]">
                <img
                    className="roar__image w-full object-contain mb-[81px] px-[16px] md:px-[36px] lg:px-[48px]"
                    src={roar}
                    alt="roar__icon" />
                <h2
                    ref={titleRef}
                    className={`roar__title sticky top-[40%] pb-[48px] text-center w-full font-black text-[56px] leading-[48px] tracking-tighter-[-2%] uppercase md:pb-0 md:mt-[159px] xl:text-[120px] xl:leading-[100px] transition-all duration-500 ${isScrolled ? 'text-white' : 'text-[#2F2F34]'
                        }`}>
                    {isScrolled ? (
                        <>
                            We love what
                ...
                <img
                    ...
                    src={footer__image}
                    alt="footer__image" />
                <div className="roar__bottom-box flex flex-col justify-center items-center bg-[#CF734A] md:hidden">
                    {data.map((item, index) => (
                        <div className="roar__box-image flex flex-col justify-center items-center" key={index}>
                            <img className="roar__images w-full rounded-[48px]" src={item.images} alt="images" />
                        </div>
                    ))}
                </div>
