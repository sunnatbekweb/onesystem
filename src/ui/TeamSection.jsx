            ...
            <section className="team bg-[#2F2F34] pt-[48px] md:pt-[100px] overflow-x-hidden">
                <div className="container team__container w-full flex flex-col justify-center items-start px-[16px] md:px-[36px] lg:px-[48px]">
                    ...
                    <div className="w-[100%] hidden mb-[31px] xl:flex xl:flex-row xl:justify-between xl:items-start">
                        {title.map((text, id) => (
                            <div className="flex flex-row justify-between items-start" key={id}>
                                <p className="font-black text-[21px] leading-[17px] tracking-tighter-[-2%] uppercase text-white">{text.titles}</p>
                            </div>
                        ))}
                    </div>
                    {backendData.map((item) => (
                        <div className="team__main-box w-full flex flex-col justify-center items-start xl:hidden" key={item.id}>
                            <div className="team__position-box hidden">
                                <p className="team__position-box-text">position</p>
                                <p className="team__position-box-texts text-[16px] leading-[16px] text-white tracking-tighter-[-2%]">{item.position}</p>
                            </div>
                            <div className="team__name-box w-full flex flex-row justify-between items-start">
                                ...
                                <p className="team__name-box-texts font-black text-[56px] leading-[56px] tracking-tighter-[-2%] text-white w-[289px] uppercase md:w-full">{item.name}</p>
                                <img className="team__name-user-image object-top w-[46px] h-[46px] rounded-[50%] md:w-[66px] md:h-[66px]" src={item.image} alt="user__image" />
                            </div>
                            <div className="team__secondPosition-box mb-3 mt-[20px] md:mb-6 md:mt-[40px]">
                                <p className="team__secondPosition-box-texts font-bold text-[16px] leading-[16px] tracking-tight-[-2%] text-white">{item.name}</p>
                            </div>
                                ...
                                <div className="team__networking-mini-box flex flex-row justify-center items-center gap-8 mr-auto md:gap-[49px]">
                                    {
                                        item.social_media?.map((social) => (
                                            <a
                                                ...
                                                <p className="team__networking-box-texts font-bold text-[16px] leading-[16px] tracking-tight-[-2%] text-white active:text-[#CF734A]">{social.social_name}</p>
                                                <ChevronIcon />
                                            </a>
                                        ))
                                    }
                    ...
                    {backendData.map((info) => (
                        <div className="team__main-box hidden xl:w-full xl:flex xl:flex-row xl:justify-between xl:items-start xl:border-y xl:pt-[17px] xl:pb-[32px] xl:border-[#444448]" key={info.id}>
                            <div className="team__position-box xl:w-full xl:flex xl:flex-col xl:justify-start xl:items-center">
                            ...
                            <div className="team__name-box xl:w-full xl:flex xl:flex-col xl:justify-center xl:items-center">
                                <p className="team__name-box-texts xl:cursor-pointer xl:text-center xl:w-max xl:font-black xl:text-white xl:text-[56px] xl:leading-[56px] xl:tracking-tighter-[-2%] xl:uppercase"
                            ...
                            <div className="team__networking-box transition-all xl:w-full xl:flex xl:flex-row xl:justify-end xl:items-start xl:gap-x-[49px]">
                                {
                                    info.social_media?.map((item) => (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer">
                                            <p className="team__networking-box-texts xl:font-bold xl:text-[16px] xl:leading-[16px] xl:tracking-tight-[-2%] xl:text-white xl:active:text-[#CF734A]">{item.social_name}</p>
                                            <ChevronIcon />
                                        </a>
                                    ))
                                }
