            ...
            <div className="footerComponent w-full bg-[#EAEAEA] pt-[91px] pb-[120px] xl:pt-[55px] xl:pb-[79px]">
                <div
                    ...
                    <div className="footerComponent__mini-boxes flex flex-col justify-center items-center gap-[4px] lg:gap-[20px]">
                        ...
                        <a className="footerComponent__mini-boxes-email text-center font-black text-[20px] leading-[20px] tracking-tighter-[-2%] text-[#2F2F34] uppercase w-[228px] lg:w-full" href="mailto:hello@roar.com">
                            hello@roar.com
                        </a>
                    </div>
                    <div className="footerComponent__mini-boxes flex flex-col justify-center items-center gap-[4px] lg:gap-[20px]">
